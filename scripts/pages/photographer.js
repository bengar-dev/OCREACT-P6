...
async function getPhotographer() { // fonction async qui va nous permettre d'obtenir les détails de notre Photograph
    ...
    const findPhotograph = array.find(p => p.id == currentIdPhotograph) // on cible le photograph obtenu dans notre tableau en le filtran avec l'id obtenu dans l'url
